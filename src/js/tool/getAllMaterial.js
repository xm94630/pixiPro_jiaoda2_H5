...
export default function getAllMaterial(app){
  ...
  var list = {
    ...
    //游戏背景介绍文字
    ,storyTextMC:function(){
      var txt = new PIXI.Text('张无忌陡地领会，原来她真正所爱的，乃是她心中所想像的张无忌，是她记忆中在蝴蝶谷所遇上的张无忌，那个打她咬她、倔强凶狠的张无忌，却不是眼前这个真正的张无忌，不是这个长大了的、待人仁恕宽厚的张无忌。他心中三分伤感、三分留恋、又有三分宽慰，望着她的背影消失在黑暗之中。他知道殷离这一生，永远会记着蝴蝶谷中那个一身狠劲的少年，她是要去找寻他。她自然找不到，但也可以说，她早已寻到了，因为那个少年早就藏在她的心底。真正的人、真正的事，往往不及心中所想的那么好。',{
        fontSize: 50,
        fill: 0x000,
        //文字折行的核心
        "breakWords": true,
        "wordWrapWidth": 600, //这个是数字和下面width保持一致，要是大于600，文字是压扁的状态
        "wordWrap": true
      });
      txt.width = 600;
      txt.name = "toryText"
